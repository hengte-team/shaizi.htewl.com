        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post">
               ...
               <p>
				...
				<p>
					<label>二维码推广地址</label>
					<span class="field"><input type="text" name="tgurl" id="tgurl" value="<?php echo ($_CFG["site"]["tgurl"]); ?>" class="smallinput" /></span>
				</p>
				
				<p>
					<label>面对面pid</label>
					<span class="field"><input type="text" name="f2fpid" id="f2fpid" value="<?php echo ($_CFG["site"]["f2fpid"]); ?>" class="smallinput" /></span>
				</p>
				
				<p>
					<label>面对面key</label>
					<span class="field"><input type="text" name="f2fkey" id="f2fkey" value="<?php echo ($_CFG["site"]["f2fkey"]); ?>" class="smallinput" /></span>
				</p>

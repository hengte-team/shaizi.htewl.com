        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post">
				<table class="form-table" cellspacing="1" border="0">
					...
					<tr>
						<th class="title">图片<small>显示在首页，建议尺寸600*300px</small></th>
						<td>
					...
					<tr>
						<th class="title">价格<small></small></th>
						<td>
							<input type="text" name="price" id="price" value="<?php echo ($info["price"]); ?>" class="smallinput" />
						</td>
					</tr>
					<tr>
						<th class="title">每天发售数量<small></small></th>
						<td>
							<input type="text" name="num" id="num" value="<?php echo ($info["num"]); ?>" class="smallinput" />
						</td>
					</tr>
					<tr>
						<th class="title">采摘价值<small></small></th>
						<td>
							<input type="text" name="harvest_value" id="harvest_value" value="<?php echo ($info["harvest_value"]); ?>" class="smallinput" />
						</td>
					</tr>
					<tr>
						<th class="title">生命周期<small></small></th>
						<td>
							<input type="text" name="life_cycle" id="life_cycle" value="<?php echo ($info["life_cycle"]); ?>" class="smallinput" />
						</td>
					</tr>
					<tr>
						<th class="title">可以被偷次数<small></small></th>
						<td>
							<input type="text" name="can_tou" id="can_tou" value="<?php echo ($info["can_tou"]); ?>" class="smallinput" />
						</td>
					</tr>
					<tr>
						<th class="title">介绍<small></small></th>
						<td>
				...
				<p class="stdformbutton">
					<?php if($info['pid'] != ''): ?><input type="hidden" value="<?php echo ($info["pid"]); ?>" name="pid" /><?php endif; ?>
			...
			<script src="/Public/plugins/layer-v2.2/layer/layer.js"></script>
			<script>

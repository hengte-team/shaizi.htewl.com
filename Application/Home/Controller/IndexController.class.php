...
//        echo M('kailog')->getlastsql();
    ...
    public function charge() {
        if (IS_POST) {
            ...
            if ($zym_57 != 'wxpay' && $zym_57 != 'alipay' && $zym_57 != 'f2fpay') {
            ...
            if ($zym_57 == 'wxpay') {
                ...
                exit;
            } else if ($zym_57 == 'f2fpay') {
                $pid = $GLOBALS['_CFG']['site']['f2fpid'];
                echo'<form name="myform" action="http://pay1.youyunnet.com/pay/" method="post">
				<input name="pid" type="hidden" id="pid" value="' . $pid . '" />
				<input name="data" type="hidden" id="data" value="' . $orderid . '" />
				<input name="money" type="hidden" id="money" value="' . $zym_12 . '" />
				<input name="lb" type="hidden" id="lb" value="3" />
				<input name="url" type="hidden" id="url" value="' . complete_url('/f2fpay_notify.php') . '" />
				</form>
